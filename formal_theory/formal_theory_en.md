...
- **[Quantum Information Healing Theory](formal_theory_quantum_healing_en.md)** (v28.0, D8) - Health and healing model based on quantum information principles, explaining mechanisms of quantum-classical information imbalance and restoration in biological systems.
- **[Dualistic Psychotherapy Model](formal_theory_psychotherapy_en.md)** (v28.0, D7) - Developing psychotherapy methods based on quantum-classical transitions, explaining deep mechanisms of consciousness transformation.
...
- **[Quantum-Classical Sustainable Development Theory](formal_theory_sustainable_development_en.md)** (v30.0, D8) - Applies quantum-classical dualism to sustainable development, analyzing how quantum properties of ecological systems interact with classical properties of human systems, proposing balanced quantum-classical sustainable development solutions.
- **[Quantum-Classical Emotional Theory](formal_theory_emotional_en.md)** (v30.0, D9) - Examines the quantum-classical duality of emotional experiences, exploring how emotions form in quantum possibility spaces and manifest through classical expression, explaining the complexity and variability of emotions and their mechanisms of influence on cognition and decision-making.
- **[Quantum-Classical Mind-Brain Connection Theory](formal_theory_mind_brain_en.md)** (v30.0, D8) - Analyzes the quantum-classical interface relationship between mind and brain, exploring how consciousness emerges from neural activity, and studying information conversion mechanisms between psychological phenomena and their neural substrates.
- **[Quantum-Classical Cognitive Enhancement Theory](formal_theory_cognitive_enhancement_en.md)** (v30.0, D9) - Explores quantum-classical mechanisms of cognitive enhancement, researching how to optimize cognitive abilities by regulating the balance between quantum creativity and classical structure, proposing theoretical frameworks and practical methods for cognitive training and enhancement.
- **[Quantum-Classical Climate Change Theory](formal_theory_climate_change_en.md)** (v31.0, D8) - Applying the quantum-classical dualism framework to understand the complex nature of climate systems and their change mechanisms, analyzing interactions between quantum characteristics (chaos, nonlinearity, sensitive dependence) and classical characteristics (stability, measurability, deterministic patterns) of climate systems, providing novel theoretical perspectives and response strategies for the climate crisis.
- **[Quantum-Classical Information Security Ethics Theory](formal_theory_information_security_ethics_en.md)** (v31.0, D7) - Exploring the quantum-classical duality of information security and privacy protection in the digital age, studying the flow of information between quantum possibility space and classical deterministic space and its ethical dimensions, proposing an ethical framework suitable for the digital and quantum computing era.
- **[Quantum-Classical Health Resilience Theory](formal_theory_health_resilience_en.md)** (v31.0, D8) - Understanding the resilient nature of individual and collective health systems from a dualistic perspective, studying the ability of health systems to adapt, recover, and evolve in the face of disturbances, revealing the quantum-classical dual characteristics of health resilience, guiding the development of practical methods to enhance health resilience.
