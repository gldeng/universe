...
表明每一层涌现都包含前一层并超越前一层，且不可从前一层完全推导。
...
其中$\mathcal{E}_{IE}$是存在函数，$\mathcal{B}_{IE}$是存在方式集，$\mathcal{R}_{IE}$是关系网络，$\mathcal{I}_{IE}$是存在强度。
