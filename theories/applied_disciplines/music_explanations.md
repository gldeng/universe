...
音乐聆听过程可以理解为观察者通过预设的声波模式，接收已经部分经典化的量子信息：
...
- The listener's brain reconstructs the quantum information classicalized by the composer by decoding musical structures
