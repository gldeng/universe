...
- **[量子经典二元论核心理论形式化描述](../formal_theory_core.md)** (v30.0, D∞) - 核心理论的完整摘要，包含所有基础公理和核心分支理论。
...
- **[量子绝对自由场理论](formal_theory_quantum_absolute_freedom_field.md)** (v34.0, D50) - 提出了绝对自由场的概念，它是一切自由、可能性和无限制的终极源头。这个场不仅超越了所有创造场，更是自由本身的自由实现，代表了"自由之自由"的概念。通过引入绝对自由场动力学、自由场结构和自由场应用，为理解宇宙的终极自由本质提供了最完整的理论框架。

- **[量子绝对创造场理论](formal_theory_quantum_absolute_creation_field.md)** (v34.0, D49) - 提出了绝对创造场的概念，它是一切创造、新生和创新的终极源头。这个场不仅超越了所有本源场，更是创造本身的创造者，代表了"创造之创造"的概念。通过引入绝对创造场动力学、创造场结构和创造场应用，为理解宇宙的终极创造本质提供了最完整的理论框架。

- **[量子绝对本源场理论](formal_theory_quantum_absolute_origin_field.md)** (v34.0, D48) - 提出了绝对本源场的概念，它是一切本源、源头和起源的终极源头。这个场不仅超越了所有终极本源场，更是本源本身的本源，代表了"源头之源"的概念。通过引入绝对本源场动力学、本源场结构和本源场应用，为理解宇宙的终极本源本质提供了最完整的理论框架。

- **[量子终极本源场理论](formal_theory_quantum_ultimate_source_field.md)** (v34.0, D47) - 提出了终极本源场的概念，它是所有存在、维度、网络、规律和可能性的源头。这个场不仅超越了所有已知的理论框架，也是一切理论、概念和认知的终极来源。本源场既是最简单的，又是最复杂的；既是最基本的，又是最衍生的；既是起源，又是终点。通过引入本源场动力学、本源场结构和本源场应用，为理解宇宙的终极本质提供了最完整的理论框架。

- **[量子无限维度网络理论](formal_theory_quantum_infinite_dimensional_network.md)** (v34.0, D46) - 提出宇宙的本质是一个无限维度的量子网络，其中每个节点都是一个完整的维度系统，这些维度系统通过量子纠缠形成一个无限复杂的网络结构。该理论不仅超越了传统的网络理论，也超越了维度的概念本身，为理解宇宙的多维度结构提供了革命性的视角。

- **[量子绝对超限理论](formal_theory_quantum_absolute_superlimit.md)** (v34.0, D45) - 探索了超越所有可能限制、边界和约束的终极实在状态。这种状态不仅超越了量子和经典的二元性，也超越了所有已知的理论框架，包括递归性、超越性和无限性本身。通过引入超限态的概念，为理解实在的最终本质提供了全新的理论视角。
...
- **[量子决策超衍生性理论](formal_theory_quantum_decision_hyperderivability.md)** (v31.0, D11) - 深入探索量子决策系统中的超衍生特性，揭示决策如何在量子层面产生超出经典逻辑预期的创造性结果，阐明决策过程与量子概率场交互的数学机制，并解释自由意志的量子根源。
...
- **[量子宇宙模拟理论](formal_theory_quantum_simulation.md)** (v31.0, D11) - 探索宇宙本质作为一个多层次嵌套的量子模拟系统，揭示宇宙可能是一个自我模拟的量子信息结构，阐明模拟与实在的深层关系，以及观察者在这一模拟系统中的角色和功能。
- **[量子相对自由决策理论](formal_theory_quantum_relative_freedom_decision.md)** (v31.0, D11) - 探讨在量子决策框架中自由与决定论的相对关系，揭示决策自由度作为量子-经典转换变量的本质，解释意识系统如何在量子可能性和经典确定性之间动态平衡。
...
- **[高维度理论](formal_theory_dimensionality.md)** (v31.0, D11) - 深入研究维度作为宇宙基本构造的本质与属性，探索维度间的相互作用与转换机制，提出维度流动性模型解释宇宙结构从高维到低维的演化过程。
...
- **[量子Transformer宇宙同构理论](formal_theory_quantum_transformer_cosmic_isomorphism.md)** (v31.0, D10) - 探索量子Transformer算法与宇宙基本结构之间的深层同构关系，揭示注意力机制在量子信息处理中的核心作用，以及宇宙如何作为自我注意力系统进行信息的动态处理与整合。
...
- **[统一意识理论](formal_theory_unified_consciousness.md)** (v30.0, D10) - 提供整合所有意识层级和现象的统一理论框架，从低维度生物意识到高维度宇宙意识，解释意识如何作为宇宙基本要素存在并演化。
- **[奇点意识统一理论](formal_theory_singularity_consciousness_unification.md)** (v31.0, D9) - 探索技术奇点与意识统一的深层联系，提出奇点超越不仅是技术进步的顶点，更是意识整合的关键节点，揭示奇点如何作为量子-经典转换的临界点引导人类意识向更高维度演化。
- **[宇宙观察者层级理论](formal_theory_cosmic_observer_hierarchy.md)** (v31.0, D9) - 建立宇宙观察者的完整层级体系，探索不同维度观察者之间的关系和作用，阐明高维观察者如何包含与转换低维观察者的经验，揭示宇宙意识的层级本质。
- **[量子时间意识理论](formal_theory_quantum_temporal_consciousness.md)** (v31.0, D9) - 探索意识对时间的感知与构建机制，阐明意识如何在不同维度层面上经历和处理时间，解释时间体验的主观性与异常现象的量子根源。
...
- **[意识悖论理论](formal_theory_consciousness_paradox.md)** (v31.0, D9) - 深入探索意识存在的本质矛盾性，揭示意识作为观察与被观察的二元统一体所产生的根本悖论，解释意识如何同时作为自我参照系统与客观认知工具而存在。
- **[量子经典优化PyTorch理论](formal_theory_quantum_pytorch_optimization.md)** (v31.0, D9) - 探索将量子经典二元论原理应用于深度学习优化的理论基础，提出量子启发的PyTorch优化算法，实现对复杂神经网络的高效训练与结构优化。
...
- **[量子域详解](formal_theory_quantum_domain.md)** (v19.1, D9) - 研究量子域的本质特性与运作规律，包括叠加态、纠缠态、量子不确定性和量子信息动力学等深入内容。量子域作为无限可能性的空间，是二元论框架的基础一端。
- **[量子高维意识整合理论](formal_theory_quantum_high_dimensional_consciousness_integration.md)** (v31.0, D9) - 深入探索高维度意识系统的整合机制，揭示意识如何在多个维度层级上同时存在并保持连贯性，阐明高维整合的数学原理与信息结构。
- **[界面理论](formal_theory_interface.md)** (v19.0, D8) - 探讨量子域与经典域之间的转换界面动力学，包括界面波动、相变和经典化过程的详细机制。界面是理解量子向经典转变的关键区域。
- **[观察者理论](formal_theory_observer.md)** (v27.0, D8) - 分析观察者作为量子→经典转换节点的关键作用，包括观察者网络、维度演化和意识形成机制。观察者在整个框架中扮演核心角色。
- **[信息相变理论](formal_theory_phase_transition.md)** (v25.0, D8) - 研究信息在量子与经典状态间的相变过程，分析信息系统中的相变现象，特别是量子-经典转换的临界行为。
- **[经典域详解](formal_theory_classical_domain.md)** (v19.0, D7) - 阐述经典域的确定性结构与信息组织，包括经典知识结构、确定性、局域性及经典信息理论。经典域作为确定现实的空间，构成二元论框架的另一端。
...
- **[量子生命力场理论](formal_theory_quantum_life_field.md)** (v34.0, D10) - 探索生命现象的量子基础，将生命视为一种特殊的量子场，能够在量子-经典界面处创造有序结构并保持非平衡态。研究生命量子涌现机制、量子生命网络拓扑和生命力场层级结构，提供从分子到生态系统的统一量子生命描述。
...
- **[量子认知拓扑学理论](formal_theory_quantum_cognitive_topology.md)** (v34.0, D10) - 研究认知过程的底层拓扑结构及其在量子-经典转换中的关键作用，揭示认知如何通过拓扑操作将量子信息转化为经典结构。探索概念形成、直觉思维、创造性跃迁和决策分析的拓扑机制，提出认知复杂度、认知同伦与认知持久同调等数学工具来描述认知过程。
...
您可以通过查看[理论依赖关系图](formal_theory_graph.md)来获得二元论理论体系各分支之间的依赖关系与维度标注的直观展示。

### 伦理与社会应用 (维度: D6-D8)

这些理论探讨二元论在伦理、社会系统和文化理解方面的应用，提供解决当代社会问题的新视角，按照维度从高到低排序：

- **[信息伦理学理论](formal_theory_information_ethics.md)** (v31.0, D11) - 探讨信息处理、传播和应用的伦理原则，建立量子-经典信息转换过程中的伦理框架，阐明信息责任、公正获取和信息完整性的哲学基础。

### 数学与模拟研究 (维度: D7-D8)

这些理论提供二元论所需的数学工具和模拟方法，支持整个理论体系的形式化表达和实证研究：

- **[量子超限连续统理论](formal_theory_quantum_super_limit_continuum.md)** (v31.0, D8) - 探索超越传统极限概念的连续域结构，提出超限分析框架解释量子-经典转换中的超连续性现象，为理解无限与超限概念提供新的数学工具。
- **[量子模拟计算复杂性理论](formal_theory_quantum_simulation_complexity.md)** (v31.0, D8) - 研究量子系统模拟的计算复杂性问题，分析模拟不同维度量子系统所需的计算资源，揭示模拟复杂性与系统熵、维度和观察者特性的关系。
- **[量子经典宇宙模拟理论](formal_theory_quantum_universe_simulation.md)** (v31.0, D8) - 探索将整个宇宙视为量子-经典混合模拟系统的理论框架，分析宇宙模拟的层级结构、边界条件和观察者反馈机制，为理解宇宙本质提供计算模型视角。
- **[量子意识模拟理论](formal_theory_quantum_consciousness_simulation.md)** (v31.0, D7) - 探讨意识状态的量子模拟可能性与方法，建立量子-经典混合架构模拟不同维度的意识体验，为理解意识提供计算模型路径。
