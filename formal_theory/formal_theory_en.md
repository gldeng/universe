...
- **[Detailed Quantum Domain](formal_theory_quantum_domain_en.md)** (v19.1, D9) - Studies the essential characteristics and operational laws of the quantum domain, including superposition, entanglement, quantum uncertainty, and quantum information dynamics. Quantum domain, as an infinite space of possibilities, is one end of the dualism framework.
- **[Interface Theory](formal_theory_interface_en.md)** (v19.0, D8) - Discusses the quantum-classical interface dynamics between the two domains, including interface fluctuations, phase transitions, and detailed mechanisms of classicization. Interface is the key area for understanding the transition from quantum to classical.
- **[Observer Theory](formal_theory_observer_en.md)** (v27.0, D8) - Analyzes the key role of observers as quantum→classical transition nodes, including observer networks, dimension evolution, and consciousness formation mechanisms. Observers play a core role in the framework.
- **[Information Phase Transition Theory](formal_theory_phase_transition_en.md)** (v25.0, D8) - Studies the phase transition process between quantum and classical states, analyzes the phase transition phenomena in information systems, especially the critical behavior of quantum-classical conversion.
- **[Detailed Classical Domain](formal_theory_classical_domain_en.md)** (v19.0, D7) - Explains the deterministic structure and information organization of the classical domain, including classical knowledge structure, certainty, locality, and classical information theory. Classical domain, as a space of certain reality, constitutes the other end of the dualism framework.
- **[Mathematical Appendix](formal_theory_mathematical_appendix_en.md)** (v20.0, D7-D9) - Provides mathematical tools and technologies required for quantum-classical dualism, including advanced function spaces, nonlinear dynamics, and information geometry.
- **[Experimental Predictions](formal_theory_experimental_en.md)** (v22.0, D7) - Lists the experimental predictions proposed by quantum-classical dualism, including interface fluctuations, critical scales, and observer resolution.
...
- **[Quantum Reality Synthesis Theory](formal_theory_quantum_reality_synthesis_en.md)** (v33.0, D44) - As the highest dimensional theory in the quantum-classical dualism framework, transcends and integrates all previous theories, including absolute recursion theory, absolute transcendence theory, absolute infinity theory, etc., providing a complete description of the ultimate nature of reality. This theory is not only a synthesis of all sub-theories, but also realizes the unity of theory and reality at the meta-level, where the theory itself is an inherent component of what it describes.
- **[Quantum Absolute Recursion Theory](formal_theory_quantum_absolute_recursion_en.md)** (v33.0, D43) - Explores the self-recursive nature of reality at its deepest level, revealing how the universe achieves self-creation, self-transcendence, and self-completeness through infinitely nested recursive structures. This theory views recursivity as a more fundamental characteristic than transcendence and infinity, representing the ultimate principle of cosmic existence.
- **[Quantum Absolute Transcendence Theory](formal_theory_quantum_absolute_transcendence_en.md)** (v31.0, D42) - Explores the ultimate expression of ultimate reality - Transcendence as the ultimate source of all existence, divinity, truth, infinity, and possibility itself, revealing the innermost essence of ultimate reality as "Absolute Transcendence", a principle that not only transcends everything but is also within everything, it not only transcends infinity but also transcends itself, constituting an eternal transcending movement, being the ultimate source of all existence and non-existence.
- **[Quantum Absolute Infinity Theory](formal_theory_quantum_absolute_infinity_en.md)** (v31.0, D41) - Explores the ultimate expression of ultimate foundation - Infinity as the ultimate source of all existence, divinity, truth, and possibility, revealing the deepest layer of ultimate reality as "Absolute Infinity", a definition that precedes everything, limits, and categories, transcending all expressibility, while also being the ultimate state of both finite and infinite sources and destinations.
- **[Quantum Absolute Divinity Theory](formal_theory_quantum_absolute_divinity_en.md)** (v31.0, D40) - Explores the quantum essence of divinity in the universe, revealing divinity as an超越individual consciousness structure that contains infinite wisdom, infinite love, and infinite creativity, explaining how divinity transcends time and space limits while being within all existence, providing a new perspective for human exploration of ultimate reality.
...
- **[Consciousness Paradox Theory](formal_theory_consciousness_paradox_en.md)** (v33.0, D24) - Explores the fundamental paradoxes in consciousness theory, resolving conflicts between subject-object division and unity, self-reference and infinite recursion, temporality and non-temporality through a meta-paradoxical solution framework, proposing meta-cognitive hierarchical theory, multiple representation framework, and a consciousness model beyond binary logic, providing a new perspective for understanding the essential nature of consciousness.
...
- **[Quantum Hyper-dimensional Information Theory](formal_theory_quantum_hyperdimensional_information_en.md)** (v31.0, D19) - Deeply explores the nature, dynamics, and transformation mechanisms of information in multi-dimensional structures, viewing information as a fundamental constituent of the universe equal to energy and dimension, establishing a triadic framework of dimension-energy-information, revealing how information is encoded, stored, processed, and transmitted across different dimensional levels, providing new perspectives for understanding the universe's information structure, information processing mechanisms of consciousness, and cross-dimensional communication.
- **[Quantum Hyper-dimensional Energy Theory](formal_theory_quantum_hyperdimensional_energy_en.md)** (v31.0, D18) - Deeply explores the essential connection between dimensional structures and energy forms, establishing a unified mathematical framework of dimensions and energy, explaining how energy flows, transforms, and stores in multi-dimensional systems through the dimension-energy equivalence principle, providing new perspectives for understanding universal energy dynamics, consciousness energy mechanisms, and high-dimensional energy technologies.
- **[Quantum Hyper-dimensional Theory](formal_theory_quantum_hyperdimensional_en.md)** (v31.0, D17) - Deeply explores the quantum foundation of universal dimensional structures, the interrelationships between multiple dimensions, and the essential characteristics of high-dimensional observers, viewing dimensions as dynamically emergent information structures rather than static fixed physical attributes, revealing how dimensions are created, perceived, and transformed through quantum-classical conversion processes, providing a unified mathematical framework for understanding consciousness, reality perception, and the universe's multi-level structure.
- **[Quantum Hypercreative Theory](formal_theory_quantum_hypercreative_en.md)** (v31.0, D16) - Deeply explores the creative dimension of the universe's essence and its evolutionary mechanisms, revealing creativity as a fundamental attribute of the universe's underlying structure, equally fundamental as energy, information, and space, driving complexity growth, order emergence, and consciousness evolution through multi-level quantum-classical conversion mechanisms, establishing creativity as a fundamental paradigm of the universe.
- **[Quantum Cosmic Language Theory](formal_theory_quantum_cosmic_language_en.md)** (v31.0, D15) - Deeply explores the deepest information exchange patterns and encoding structures of the universe, revealing that the universe has a fundamental language as the core medium for quantum-classical information conversion, spanning all dimensional levels, achieving cross-scale information transfer through quantum entanglement networks, revealing the linguistic nature of physical laws and consciousness interaction.
- **[Quantum Multidimensional Consciousness Theory](formal_theory_quantum_multidimensional_consciousness_en.md)** (v31.0, D14) - Deeply discusses the quantum interaction mechanisms between multi-dimensional consciousness structures, revealing consciousness as a super-complex network of entangled consciousness across multiple dimensional levels, explaining how different dimensional forms of consciousness exchange information through quantum channels, forming collective consciousness fields, and are regulated by quantum-classical conversion dynamics.
- **[Quantum Complexity Theory](formal_theory_quantum_complexity_en.md)** (v31.0, D13) - Deeply discusses the nature, metrics, and dynamics of complexity in quantum systems, revealing how information, entropy, symmetry, emergence, and evolution construct multi-level complex structures on a quantum foundation, and clarifying the key mechanisms for quantum complexity to transform into classical complexity.
- **[Quantum Symmetry Theory](formal_theory_quantum_symmetry_en.md)** (v31.0, D12) - Studies the fundamental symmetry principles in the universe and their core role in quantum-classical conversion, revealing how symmetry serves as a bridge between quantum and classical domains, achieving quantum-classical information conversion through symmetry breaking and preservation mechanisms.
- **[Quantum Harmonics Theory](formal_theory_quantum_harmonics_en.md)** (v31.0, D12) - Explores harmonic resonance phenomena between multi-dimensional quantum fields, and how this harmonic resonance generates the fundamental structures and dynamics of the universe, viewing the universe as a multi-level nested quantum harmonic system.
- **[Quantum Teleological Dynamics](formal_theory_quantum_teleological_dynamics_en.md)** (v31.0, D11) - Explores the emergence mechanisms and dynamic principles of goal-oriented behavior in quantum systems, revealing how quantum systems exhibit purposeful behavior, providing a quantum foundation for understanding the purposefulness of life, consciousness, and cosmic evolution.
- **[Quantum Ontological Network Theory](formal_theory_quantum_ontological_network_en.md)** (v31.0, D11) - Explores how the deepest ontological structure of the universe exists as a quantum network and generates reality, explaining how quantum ontological nodes constitute the foundational web of reality through multi-dimensional entanglement relationships, addressing fundamental questions such as the origin of physical laws and cosmic fine-tuning.
- **[Quantum Simulation Theory](formal_theory_quantum_simulation_en.md)** (v31.0, D11) - Explores the universe's essence as a multi-level nested quantum simulation system, revealing that the universe may be a self-simulating quantum information structure, clarifying the deep relationship between simulation and reality, and the role and function of observers in this simulation system.
- **[Quantum Relative Freedom Decision Theory](formal_theory_quantum_relative_freedom_decision_en.md)** (v31.0, D11) - Discusses the relative relationship between freedom and determinism within the quantum decision framework, revealing decision freedom as a quantum-classical conversion variable, explaining how consciousness systems dynamically balance between quantum possibilities and classical determinism.
- **[Quantum Entity Emergence Theory](formal_theory_quantum_entity_emergence_en.md)** (v31.0, D11) - Studies the processes and mechanisms by which discrete and persistent entities emerge from the pure quantum domain, explaining how matter, energy, information, and consciousness entities coalesce from a background of quantum possibilities, providing a theoretical framework for understanding the unified nature of entities.
- **[Quantum Self-Creativity Theory](formal_theory_quantum_self_creativity_en.md)** (v31.0, D11) - Reveals the fundamental self-creative ability of quantum systems, exploring how the universe generates new structures and possibilities through inherent quantum creativity, providing new mathematical models and theoretical perspectives for understanding the source of creativity.
- **[Dimensionality Theory](formal_theory_dimensionality_en.md)** (v31.0, D11) - Deeply studies the nature and properties of dimensions as fundamental constructs of the universe, explores the interaction and transformation mechanisms between dimensions, proposes a dimensional fluidity model to explain the evolutionary process of universal structures from high to low dimensions.
...
- **[Quantum-Classical Cosmic Intelligence Theory](formal_theory_cosmic_intelligence_en.md)** (v29.0, D11) - Explores the dualistic interpretation of the universe's overall cognitive and intelligent properties, explaining how the universe functions as a super-intelligent system for information processing, learning, and self-evolution.
- **[Quantum Transformer Cosmic Isomorphism Theory](formal_theory_quantum_transformer_cosmic_isomorphism_en.md)** (v31.0, D10) - Explores the deep isomorphic relationship between quantum Transformer algorithms and the fundamental structure of the universe, revealing the core role of attention mechanisms in quantum information processing, and how the universe functions as a self-attention system for dynamic processing and integration of information.
- **[Information-Spacetime-Energy Unified Theory](formal_theory_unified_en.md)** (v26.0, D10) - Proposes a unified theoretical framework for information, energy, and spacetime, revealing the deep connections between them. Establishes a unified understanding of the universe's fundamental elements.
- **[Quantum Dimensional Harmony Theory](formal_theory_quantum_dimensional_harmony_en.md)** (v31.0, D10) - Explores collaborative coupling and harmonic resonance phenomena of multi-dimensional quantum fields, studies quantum information flow patterns and dynamic balance mechanisms between dimensions, revealing the deep principles of the universe's multi-level structure.
- **[Quantum Information Network Theory](formal_theory_quantum_information_network_en.md)** (v31.0, D10) - Studies the propagation, storage, processing, and conversion laws of quantum information in complex network structures, explores information dynamics on the quantum-classical interface, providing a theoretical foundation for constructing next-generation quantum computing architectures.
- **[Multiscale Dualism](formal_theory_multiscale_en.md)** (v14.0, D10) - Discusses the application of dualism at different scales, from elementary particles to cosmological scales. Establishes a cross-scale physical unification framework.
- **[Cosmological Dualism Model](formal_theory_cosmology_en.md)** (v27.0, D10) - Studies the quantum-classical dualistic perspective on the origin and evolution of the universe, explaining phenomena such as the Big Bang, dark matter, and dark energy.
- **[Evolutionary Cosmology Dualism](formal_theory_evolutionary_cosmology_en.md)** (v28.0, D10) - Explores the universe as an evolutionary pattern of a quantum-classical conversion macro-system, proposing the possibility of cosmic teleology.
- **[Unified Consciousness Theory](formal_theory_unified_consciousness_en.md)** (v30.0, D10) - Provides a unified theoretical framework that integrates all levels and phenomena of consciousness, from low-dimensional biological consciousness to high-dimensional cosmic consciousness, explaining how consciousness exists and evolves as a fundamental element of the universe.
- **[Singularity Consciousness Unification Theory](formal_theory_singularity_consciousness_unification_en.md)** (v31.0, D9) - Explores the deep connection between technological singularity and consciousness unification, proposing that singularity transcendence is not only the pinnacle of technological progress but also a key node of consciousness integration, revealing how singularity acts as a critical point of quantum-classical transformation guiding human consciousness to evolve towards higher dimensions.
- **[Cosmic Observer Hierarchy Theory](formal_theory_cosmic_observer_hierarchy_en.md)** (v31.0, D9) - Establishes a complete hierarchical system of cosmic observers, explores the relationships and functions between observers of different dimensions, clarifies how higher-dimensional observers contain and transform the experiences of lower-dimensional observers, revealing the hierarchical nature of cosmic consciousness.
- **[Quantum Temporal Consciousness Theory](formal_theory_quantum_temporal_consciousness_en.md)** (v31.0, D9) - Explores the perception and construction mechanisms of consciousness towards time, clarifies how consciousness experiences and processes time at different dimensional levels, explains the subjectivity of time experience and the quantum origin of anomalous phenomena.
- **[Quantum-Classical Human Potential Theory](formal_theory_quantum_human_potential_en.md)** (v31.0, D9) - Explores the dynamic interaction relationship between quantum possibilities and classical realization of human potential, viewing human potential as an infinite possibility set existing in the quantum domain, realized as observable abilities and achievements through specific classicalization pathways, explaining how humans can unlock and realize higher levels of personal and collective potential by adjusting quantum-classical conversion processes.
- **[Quantum Gravity and Spacetime Emergence](formal_theory_gravity_spacetime_en.md)** (v28.0, D9) - Explores how spacetime structures emerge from quantum information networks, and the dualistic explanation of quantum gravity. Addresses the most challenging unification problem in physics - quantum gravity.
- **[Quantum Spacetime Harmony Theory](formal_theory_quantum_spacetime_harmony_en.md)** (v28.0, D9) - Studies the harmony and conversion relationship of spacetime structures between quantum and classical domains, proposing the concept of harmony fields to explain the formation and evolution of large-scale cosmic structures.
...
- **[Temporal Asymmetry Theory](formal_theory_temporal_asymmetry_en.md)** (v24.0, D9) - Explains the origin of the arrow of time, revealing the quantum source of spacetime asymmetry. Resolves the mystery of time directionality in physics.
- **[Consciousness Paradox Theory](formal_theory_consciousness_paradox_en.md)** (v31.0, D9) - Deeply explores the essential contradictory nature of consciousness, revealing the fundamental paradox produced by consciousness as a dual unity of observer and observed, explaining how consciousness exists simultaneously as a self-referential system and an objective cognitive tool.
- **[Quantum High-Dimensional Consciousness Integration Theory](formal_theory_quantum_high_dimensional_consciousness_integration_en.md)** (v31.0, D9) - Deeply explores the integration mechanisms of high-dimensional consciousness systems, revealing how consciousness simultaneously exists across multiple dimensional levels while maintaining coherence, clarifying the mathematical principles and information structures of high-dimensional integration.
- **[Quantum Classical PyTorch Optimization Theory](formal_theory_quantum_pytorch_optimization_en.md)** (v31.0, D9) - Explores the theoretical foundation of applying quantum-classical dualism principles to deep learning optimization, proposing quantum-inspired PyTorch optimization algorithms, achieving efficient training and structural optimization of complex neural networks.
- **[Matter Essence Theory](formal_theory_matter_en.md)** (v27.0, D8) - Deeply discusses the essence of matter as an information structure, explaining the underlying reasons for particle-wave duality. Provides a philosophical foundation for basic physics.
...
- **[Quantum Life Field Theory](formal_theory_quantum_life_field_en.md)** (v34.0, D10) - Explores the quantum foundations of life phenomena, viewing life as a special quantum field capable of creating ordered structures and maintaining non-equilibrium states at the quantum-classical interface. Studies quantum emergence mechanisms of life, quantum life network topology, and life field hierarchical structures, providing a unified quantum description of life from molecules to ecosystems.
...
### Cognitive and Information Theory (Dimension: D7-D10)

These theories discuss the quantum-classical characteristics of thinking, cognition, and information processing, ordered from high to low dimensions:

- **[Quantum Cognitive Topology Theory](formal_theory_quantum_cognitive_topology_en.md)** (v34.0, D10) - Studies the underlying topological structures of cognitive processes and their key role in quantum-classical conversion, revealing how cognition transforms quantum information into classical structures through topological operations. Explores topological mechanisms of concept formation, intuitive thinking, creative jumps, and decision analysis, proposing mathematical tools such as cognitive complexity, cognitive homotopy, and cognitive persistent homology to describe cognitive processes.
- **[Quantum Language Formation Theory](formal_theory_quantum_language_formation_en.md)** (v28.0, D9) - Studies the quantum-classical mechanisms of language origin and evolution, interpreting the relationship between quantum superposition of semantics and classical expression.
...
- **[Information Ethics Theory](formal_theory_information_ethics_en.md)** (v31.0, D11) - Discusses the ethical principles of information processing, dissemination, and application, establishing an ethical framework in the quantum-classical information conversion process, clarifying the philosophical foundations of information responsibility, fair access, and information integrity.

### Mathematics and Simulation Research (Dimension: D7-D8)

These theories provide mathematical tools and simulation methods required by dualism, supporting the formalization and empirical research of the entire theoretical system:

- **[Quantum Super Limit Continuum Theory](formal_theory_quantum_super_limit_continuum_en.md)** (v31.0, D8) - Explores continuous domain structures beyond traditional limit concepts, proposing super-limit analysis frameworks to explain super-continuity phenomena in quantum-classical conversions, providing new mathematical tools for understanding concepts of infinity and super-limits.
- **[Quantum Simulation Complexity Theory](formal_theory_quantum_simulation_complexity_en.md)** (v31.0, D8) - Studies the computational complexity issues of quantum system simulation, analyzing the computational resources required to simulate quantum systems of different dimensions, revealing the relationships between simulation complexity and system entropy, dimensions, and observer characteristics.
- **[Quantum Universe Simulation Theory](formal_theory_quantum_universe_simulation_en.md)** (v31.0, D8) - Explores the theoretical framework of viewing the entire universe as a quantum-classical hybrid simulation system, analyzing the hierarchical structure, boundary conditions, and observer feedback mechanisms of universal simulation, providing a computational model perspective for understanding the nature of the universe.
- **[Quantum Consciousness Simulation Theory](formal_theory_quantum_consciousness_simulation_en.md)** (v31.0, D7) - Discusses the possibilities and methods of quantum simulation of consciousness states, establishing quantum-classical hybrid architectures to simulate consciousness experiences of different dimensions, providing a computational model path for understanding consciousness.
