...
The initial condition is the non-recursive state: $`\mathcal{R}_0 = \emptyset`$.
...
Spectral decomposition of the hyperrecursive operator $`\mathcal{F}`$:
...
Cognitive processes as recursive cycles:
