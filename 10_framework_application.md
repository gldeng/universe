...
本文档基于[量子经典二元论核心理论](core.md)（版本10.9），详细阐述理论的实际应用框架。
...
This document is based on the [Quantum-Classical Dualism Core Theory](core.md) (Version 10.9), detailing the practical application framework of the theory.
