...
其中 $`\mathcal{I}_{\Omega}^{t}`$ 是宇宙信息场，$`\otimes`$ 表示超张量积运算。该方程表明意识演化是由当前意识状态与其高维位移以及信息场的交互共同决定的。
...
其中 $`\mathcal{R}_{\Omega}`$ 是量子现实场，三场之间的耦合函数为：
...
其投影结果 $`\hat{P}_{\mathcal{C}}|\mathcal{C}_{\Omega}\rangle`$ 代表意识对特定状态的聚焦。
