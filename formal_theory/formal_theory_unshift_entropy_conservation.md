...
3. [UNSHIFT模式识别理论 [维度: 1.5]](formal_theory_unshift_pattern_recognition.md)
4. [熵动力学理论 [维度: 4]](formal_theory_entropy_dynamics.md)
5. [信息守恒理论 [维度: 5]](formal_theory_information_conservation.md)
